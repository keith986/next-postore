...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Store signup data in sessionStorage — account created after payment
      ...
      <div className="page-wrap">
        <div className="left">
          ...
          <div className="hero">
            ...
            <p className="hero-body">Set up your POS in minutes. No hidden fees, cancel anytime.</p>
          </div>
          <div className="steps">
            <div className="step">
            ...
            <div className="step">
              ...
              <div className="step-text"><strong>Choose a plan</strong><br />Pay via M-Pesa STK push</div>
            </div>
            <div className="step">
        ...
        <div className="right">
          <div className="form-card">
            ...
            <p className="form-sub">Fill in your details. Your account is created after payment.</p>
            ...
            <form onSubmit={handleSubmit}>
              <div className="field">
                ...
                <input type="text" placeholder="John Doe" value={form.full_name} onChange={e => update("full_name", e.target.value)} />
              </div>
              <div className="field">
              ...
              <div className="field">
                ...
                <input type="text" placeholder="My Awesome Store" value={form.store_name} onChange={e => update("store_name", e.target.value)} />
              </div>
              <div className="field">
                <label>Store domain</label>
                <input type="text" placeholder="mystore" value={form.domain} onChange={e => update("domain", e.target.value.toLowerCase().replace(/[^a-z0-9]/g, ""))} />
                <p className="field-hint">Your store URL: <strong>{form.domain || "mystore"}.upendoapps.com</strong></p>
              </div>
