...
const css = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* LEFT — fixed height, never scrolls */
  .left {
  ...
  .domain-input {
    ...
    outline: none; padding: 9px 0 9px 12px;
    color: var(--ink);
    font-family: 'DM Sans', sans-serif;
  ...
  .domain-hint {
    ...
    margin-top: 5px; font-size: 12px; min-height: 18px;
  }
...
export default function SignupPage() {
  ...
  let domainTimer : NodeJS.Timeout;
  ...
  const checkDomain = (slug : string) => {
    ...
    domainTimer = setTimeout(() => {
      setDomainStatus(TAKEN.includes(slug) ? "bad" : "ok");
    }, 650);
  };
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="field">
                ...
                <div className={`domain-hint ${domainStatus}`}>
                  ...
                  {domainStatus === "ok"       && `${form.domain}.vendx.app is available`}
