  ...
  useEffect(() => {
    ...
    if (!stored) {
      ...
      try {
        ...
        //  localStorage data can be tampered with, so we do a basic check before trusting it
        if (typeof parsed.id !== "string" || typeof parsed.full_name !== "string") {
  ...
  return (
    <aside className="sidebar">
      ...
      <div className="sidebar-logo">
        <div className="sidebar-logo-mark">{user ? user.store_name?.charAt(0).toUpperCase() : "P"}</div>
        <span className="sidebar-logo-name">{user ? user.store_name?.charAt(0).toUpperCase() + '' + user.store_name?.slice(1).toLowerCase() : "POStore"}</span>
      </div>
